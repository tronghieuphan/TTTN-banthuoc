...
function Footer() {
    ...
    return (
        <>
                ...
                <div className="row px-xl-5 pt-5">
                    <div className="col-lg-12 col-md-12 mb-5 pr-3 pr-xl-5 text-center">
                        ...
                        <div style={{ fontWeight: "600" }}>
                            ...
                            <p className="mb-2">Lưu Trung Lâm - DH51903858</p>
                            <p className="mb-2">Nguyễn Cao Hùng - DH51903640</p>
                        </div>
                    </div>
                </div>
            </div>
            <div>
                <div
                    style={{ background: "#005CB2", fontWeight: "600" }}
                    className=" text-white p-3 text-center "
                >
                    <div>
                        ©2023 Nhóm 1 - Tên sản phẩm : WEBSITE NHÀ THUỐC - Môn học: THỰC TẬP TỐT
                        NGHIỆP <br />
                        Trường Đại Học Công Nghệ Sài Gòn - Số điện thoại: 0123456789 - Email:
                        hlvlh@gmail.com
                    </div>
                </div>
            </div>
